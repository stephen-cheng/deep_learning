...
tf.app.flags.DEFINE_string('validation_directory', 'dataset/test',
...
tf.app.flags.DEFINE_string('labels_file', 'dataset/labels', 'Labels file')
...
def _convert_to_example(filename, image_buffer, label, text):
  ...
  example = tf.train.Example(features=tf.train.Features(feature={
      ...
      'image/encoded': _bytes_feature(tf.compat.as_bytes(image_buffer.tostring()))}))
  return example
