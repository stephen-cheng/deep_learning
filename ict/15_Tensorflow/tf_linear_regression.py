...
y_hat2 = tf.add(tf.multiply(X, w_hat2), b_hat2)
...
with tf.Session() as sess:
    ...
    for i_epoch in range(n_epochs):
        ...
        if i_epoch % 20 == 0:
            ...
            print(training_cost)
            # ax.plot(xs, y_hat2.eval(feed_dict={x: xs}, session=sess), 'r', alpha=i_epoch / n_epochs) # something wrong with this function, //TODO
            fig.show()
            plt.draw()
